...
function Dashboard() {
  ...
  const getStatusTag = (status?: string) => {
    switch (status) {
      case ErrorStatus.RESOLVED:
        return (
          <Tag color="success">{ErrorStatusLabels[ErrorStatus.RESOLVED]}</Tag>
        );
      case ErrorStatus.IN_PROGRESS:
        return (
          <Tag color="processing">
            {ErrorStatusLabels[ErrorStatus.IN_PROGRESS]}
          </Tag>
        );
      default:
        return (
          <Tag color="default">{ErrorStatusLabels[ErrorStatus.UNRESOLVED]}</Tag>
        );
    }
  };
  ...
  const columns = [
    ...
    },
    {
      ...
      filters: [
        {
          text: ErrorCategoryLabels[ErrorCategory.API_ERROR],
          value: ErrorCategory.API_ERROR,
        },
        {
          text: ErrorCategoryLabels[ErrorCategory.FRONTEND_ERROR],
          value: ErrorCategory.FRONTEND_ERROR,
        },
        {
          text: ErrorCategoryLabels[ErrorCategory.OTHER],
          value: ErrorCategory.OTHER,
        },
      ],
      onFilter: (value: unknown, record: ErrorItem) =>
          ...
          <div className="dashboard-stats-row">
            ...
            <Card className="dashboard-stat-card">
              <Statistic
                ...
                value={
                  errorData.filter(
                    (item) => item.status === ErrorStatus.RESOLVED
                  ).length
                }
